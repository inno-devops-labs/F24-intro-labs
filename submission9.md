...
- I've modified the github-actions-demo.yml to Configure a Manual Trigger:
- I've added the following part:
```bash
on:
  push:
    branches:
  ...
  workflow_dispatch:  
```
- And then I modified it again to gather system information:
- I've added the following part:
```bash
...
System Information
Linux fv-az520-677 6.8.0-1014-azure #16~22.04.1-Ubuntu SMP Thu Aug 15 21:31:41 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux
Architecture:                         x86_64
CPU op-mode(s):                       32-bit, 64-bit
Address sizes:                        48 bits physical, 48 bits System Information
Linux fv-az520-677 6.8.0-1014-azure #16~22.04.1-Ubuntu SMP Thu Aug 15 21:31:41 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux
Architecture:                         x86_64
CPU op-mode(s):                       32-bit, 64-bit
